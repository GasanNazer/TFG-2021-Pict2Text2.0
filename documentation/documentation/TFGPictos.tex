...
\ifpdf\hypersetup{%
    pdftitle = {\titulo},
    pdfsubject = {TFG Pict2Text2.0},
    pdfkeywords = {TFG Pict2Text2.0},
    pdfauthor = {\textcopyright\ \autorA and \autorB},
...
%\include{Capitulos/MetodologiaDeTrabajo}
%\include{Capitulos/ServiciosWeb}
...
\include{Capitulos/Introduccion}
\include{Capitulos/EstadoDeLaCuestion}
\include{Capitulos/SoftwareDevelopmentMethodology}
\include{Capitulos/Implementation}
\include{Capitulos/IndividualWork}
