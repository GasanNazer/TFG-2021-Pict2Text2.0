...
% director
\def\directorPortadaVal{Director no definido. Usa
...
% codirector
\def\codirectorPortadaVal{Co-director no definido. Usa
  \texttt{$\backslash$tutorPortada}}
...
\textit{Memoria que presenta para optar al t\'{i}tulo de Doctor en Inform�tica}  \\ [0.3em]%
...
% Segundo subt\'{i}tulo de la segunda portada
...
\textbf{Arquitectura y metodolog�a para el uso }}
\begin{center}
\rule{\longTitulo}{.5mm}\\
\vskip 1cm
