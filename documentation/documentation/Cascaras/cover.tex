...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\imagenPortada{Imagenes/Bitmap/escudo}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\directorPortada{Virginia Francisco Gilmart\'{i}n}
\codirectorPortada{Susana Bautista Blasco}
...
\textbf{Bachelor's Degree Final Project in Software Engineering}  \\ [0.3em]
}
...
\textbf{Convocation: }\textit{June \the\year{}}
}
